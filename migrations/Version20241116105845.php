 ...
 */
final class Version20241116105845 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE record CHANGE created_at created_at DATETIME(6) NOT NULL COMMENT \'(DC2Type:datetime)\', CHANGE details details longtext DEFAULT NULL, CHANGE updated_at updated_at DATETIME(6) DEFAULT NULL COMMENT \'(DC2Type:datetime)\'');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE record CHANGE created_at created_at DATETIME NOT NULL, CHANGE details details JSON DEFAULT NULL COMMENT \'(DC2Type:json)\', CHANGE updated_at updated_at DATETIME DEFAULT NULL');
